	...
	<div class="panel panel-primary">
		...
		<div class="row">
			<div class="col-sm-12" style="text-align:right;">
				<div class="btn btn-primary" style="width:120px;"> เพิ่มผู้สมัครร่วม </div>
			</div>
		</div>
		<hr/> 
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-3" style="text-align:right;">
				<a href="<?=base_url()?>register/register_check/"><div class="btn btn-success" style="width:40%;margin-right:19%"> ขั้นตอนถัดไป </div></a>
			</div>
		</div>
		<br/><br/>
